...
{
    [TestFixture]
    public class PostCardControllerTest : ControllerTestBase
    {
        /// <summary>
        ...
        /// </summary>
        [Test]
        public async Task TestTestListPostcards() 
        {
            ...
            try
            {
                result = await controller.CreateListPostcardsAsync(page, pagesize, postcardid, dateCreated);
            }
            catch(APIException) {};
